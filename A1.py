...
out_vid = cv2.VideoWriter('output.avi', fourcc, 20.0, (640,  480))
...
while True:
    ...
    if img_counter < 10 * vid_length:
        img_counter += 1
        print(img_counter)
        
    else:
        break
    out_vid.write(cframe)
    ...
    #         print(np.linalg.lstsq(dI, diff))
    #         # print(np.linalg.solve(dI, diff))
